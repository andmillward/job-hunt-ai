...
import { FileUp, Briefcase, FileText, Settings, Loader2, CheckCircle, AlertCircle, Code, Eye, ExternalLink, X, Moon, Sun, Trash2, Globe, Send, DollarSign, Clock, Search, ListFilter, ArrowLeft, LayoutDashboard, Target, Sparkles, Radar, Radio, TrendingUp, Info, Bug } from 'lucide-react'
                     ...
                     <div className="animate-in fade-in duration-500 space-y-8">
                        <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm flex justify-between items-center">
                           ...
                           <div className="flex gap-3">
                              <button 
                                ...
                                disabled={rankingJobs || jobs.length === 0}
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
                           <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50">
                              ...
                              <span className="text-[10px] font-black text-indigo-600 px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 rounded-full">{jobs.length} Total Matches</span>
                           </div>
                           <div className="max-h-[700px] overflow-y-auto divide-y divide-slate-100 dark:divide-slate-800">
                              {jobs.length === 0 ? (
                                 ...
                                 rankedJobs.map(j => {
                                    ...
                                    return (
                                       <div key={j.id} className="p-8 flex items-start justify-between hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-all group">
                                          <div className="flex-1 min-w-0">
                                             ...
                                             <p className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-[0.1em] flex items-center gap-4 mb-4">
